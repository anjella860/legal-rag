...
이 프로젝트는 RAG(Retrieval-Augmented Generation) 기술을 활용하여 자연어 질문에 대해 관련 법령 조문을 검색하고, LLM이 누구나 이해하기 쉬운 답변을 생성한다. 답변과 함께 근거 조문을 함께 제공하여 신뢰성을 높였다.
...
**왜 OpenAI 임베딩 대신 ko-sroberta를 선택했나**
